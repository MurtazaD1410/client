...
const PropertyDetails = () => {
  ...
  const creator = propertyDetails.creator.email



  const isCurrentUser = user.email === creator;
  ...
  return (
    ...
    >
      ...
      <Box mt="20px" display="flex" flexDirection={{ xs: 'column', lg: 'row' }} gap={4}>
        ...
        <Box width="100%" flex={1 / 2} display="flex" sx={{ flexDirection: { xs: 'column', sm: 'row', lg: 'column' } }} gap="20px">
          <Stack
            width="100%"
            p={2}
            direction="column"
          ...
          <Stack
            ...
            <img
              ...
              width="100%"
              height={306}
              style={{ borderRadius: 10, objectFit: 'cover', marginBottom: '20px' }}
            />
